...
public class AlbumGridView extends GridView{
	 ...
	 *  @param listener 选择图片后执行的回调函数
	 */
	public void setEditable(boolean editable,OnCheckedChangeListener listener){
		mEditable=editable;
	...
	public class AlbumViewAdapter extends BaseAdapter implements OnClickListener,CompoundButton.OnCheckedChangeListener
	{
		 ...
		 *  @param listener
		 */
		public void notifyDataSetChanged(OnCheckedChangeListener listener) {
			//重置map
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			com.linj.album.view.ThumbnaiImageView albumItemView = (com.linj.album.view.ThumbnaiImageView)convertView;
			if (albumItemView == null) albumItemView = new com.linj.album.view.ThumbnaiImageView(getContext(),mImageLoader,mOptions);
		...
		public void onClick(View v) {
			if(getOnItemClickListener()!=null){
				...
				com.linj.album.view.ThumbnaiImageView view=(com.linj.album.view.ThumbnaiImageView)v.getParent().getParent();
